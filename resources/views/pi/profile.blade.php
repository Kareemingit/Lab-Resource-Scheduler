...
<body>
    <div class="topbar" id="topbar">
        ...
        <div class="topbar-nav" id="topNav">
            <a class="nav-btn" href="{{ route('pi.home', ['id' => $user->user_id]) }}">Home</a>
            <a class="nav-btn" href="{{ route('pi.reservation', ['id' => $user->user_id]) }}">Reservations</a>
            <a class="nav-btn active" href="{{ route('pi.home', ['id' => $user->user_id]) }}">Profile</a>
        </div>
    ...
    <div class="main" style="max-width:100%">
        ...
        <div class="card">
            ...
            <form action="{{ route('pi.update_profile', ['id' => $user->user_id]) }}" method="POST">
                @csrf
                @method('PUT')
