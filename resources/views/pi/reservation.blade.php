...
<body>
    <div class="topbar" id="topbar">
        ...
        <div class="topbar-nav" id="topNav">
            <a class="nav-btn" href="{{ route('pi.home', ['id' => $pi->user_id]) }}">Home</a>
            <a class="nav-btn active" href="{{ route('pi.reservation', ['id' => $pi->user_id]) }}">Reservations</a>
            <a class="nav-btn" href="{{ route('pi.profile', ['id' => $pi->user_id]) }}">Profile</a>
        </div>
  ...
  <tbody>
    ...
    <tr>
        ...
        <td><a class="btn btn-accent btn-sm" href="{{ route('pi.authorize', ['id' => $reservation->researcher_id, 'eq_id' => $reservation->eq_id]) }}">Authorize</a></td>
