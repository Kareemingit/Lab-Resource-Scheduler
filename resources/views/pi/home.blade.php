...
<body>
    <div class="topbar" id="topbar">
        ...
        <div class="topbar-nav" id="topNav">
            <a class="nav-btn active" href="{{ route('pi.home', ['id' => $pi->user_id]) }}">Home</a>
            <a class="nav-btn" href="{{ route('pi.reservation', ['id' => $pi->user_id]) }}">Reservations</a>
    ...
    <div class="page active" id="page-home">
        <div class="main" style="max-width:100%">
            <div class="page-header">
                <h1>Dashboard</h1>
                <p>Welcome back, {{ Auth::user()->name ?? 'PI' }}.</p>
            </div>
