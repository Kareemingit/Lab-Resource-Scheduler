...
<head>
    ...
    <title>Financial Department - Projects</title>
    <style>
        :root {
        --bg: #f4f5f7;
        --surface: #ffffff;
...
<body>
    <div class="main" style="max-width:100%">
        <div class="page-header">
            ...
            <p>Assign grants to projects and manage research funding</p>
        </div>

        <div class="action-bar">
            <div></div>
            <div class="btn-group">
                <a href="#assignGrantModal" class="btn btn-accent btn-sm">+ Assign Grant</a>
            </div>
        </div>
        ...
        <div class="grid-2" style="margin-bottom:16px">
            ...
            <div class="card">
                ...
                <div class="card-sub">Total allocated vs. used budget across all projects</div>
            ...
            <div class="card">
                ...
                <div class="card-sub">Active research projects with assigned grants</div>
            ...
            <div class="card">
                ...
                <div class="card-sub">Usage vs. allocated per grant</div>
                <div style="margin-top:8px">
                    @foreach($grants ?? [] as $g)
                        <div class="bar-row">
                            <div class="bar-label">{{ $g->grant_id }}</div>
                            <div class="bar-track">
                            </div>
                        </div>
                    @endforeach
    ...
    <!-- MODAL: ASSIGN BUDGET -->
    <div class="overlay" id="assignBudgetModal">
        <div class="modal">
            <div class="modal-head">
                <div class="modal-title">Assign Grant to Project</div>
                <a href="#" class="modal-close">×</a>
            </div>
            <form action="{{ route('financial_department.update_budget', ['id' => $user->user_id]) }}" method="POST">
                @csrf
                @method('PUT')
                <div class="form-group">
                    <label>Amount to Add</label>
                    <input type="number" name="amount" placeholder="e.g. 10000" required min = "0">
                </div>
                <div class="btn-group" style="justify-content:flex-end; margin-top:10px">
                    <a href="#" class="btn btn-ghost">Cancel</a>
                    <button type="submit" class="btn btn-accent">Assign</button>
                </div>
            </form>
        </div>
    </div>

    <!-- MODAL: Assign grant to a project -->
    <div class="overlay" id="assignGrantModal">
        <div class="modal">
            <div class="modal-head">
                <div class="modal-title">Assign Grant to Project</div>
                <a href="#" class="modal-close">×</a>
    ...
    <!-- MODAL: Add funds to a grant -->
    <div class="overlay" id="edit-proj-{{ $p->project_id }}">
        <div class="modal">
            <div class="modal-head">
                <div class="modal-title">Update Grant Budget</div>
                <a href="#" class="modal-close">×</a>
            </div>
            <form action="" method="POST">
                @csrf
                ...
                <div class="btn-group" style="justify-content:flex-end; margin-top:10px">
                    <a href="#" class="btn btn-ghost">Cancel</a>
                    <button type="submit" class="btn btn-accent">Update Budget</button>
                </div>
            </form>
        </div>
    </div>
