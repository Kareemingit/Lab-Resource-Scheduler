...
<body>
    <div class="topbar" id="topbar">
        ...
        <div class="topbar-right">
            <div class="role-pill r-researcher">Admin</div>
            <div class="avatar">
                US
            </div>
        </div>
    ...
    <div class="page active" id="page-users">
        <div class="main">
            ...
            <form action="{{ route('admin.users', $id) }}" method="GET" class="search-row">
                <div class="search-input-wrap">
                    <input name="search" value="{{ request('search') }}" placeholder="Search by name or role...">
    ...
    <!-- ════ CSS MODAL (No JS needed) ════ -->
    <!-- <style>
        .overlay { display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 1000; }
        .overlay:target { display: flex; align-items: center; justify-content: center; }
        .modal { background: white; padding: 20px; border-radius: 8px; width: 400px; position: relative; }
        .close-btn { position: absolute; top: 10px; right: 10px; text-decoration: none; color: #000; font-size: 20px; }
    </style> -->
