...
<body>
    <div class="topbar" id="topbar">
        ...
        <div class="topbar-nav" id="topNav">
            <a class="nav-btn" href="{{ route('supervisor.home', ['id' => $supervisor->user_id]) }}">Home</a>
            <a class="nav-btn active" href="{{ route('supervisor.reservation', ['id' => $supervisor->user_id]) }}">Reservations</a>
            <a class="nav-btn" href="{{ route('supervisor.profile', ['id' => $supervisor->user_id]) }}">Profile</a>
        </div>
  ...
  <tbody>
    ...
    <tr>
        ...
        <td>{{ $equipments->findOrFail($reservation->eq_id)->name }}</td>
        <td>{{ $reservation->eq_id }}</td>
        <td>{{ $reservation->researcher_id }}</td>
        <td>{{ $reservation->start_date }}</td>
        <td>{{ $reservation->end_date }}</td>
        <td>{{ $reservation->res_hours }}</td>
        <td>{{ $reservation->authorized }}</td>
        <td><a class="btn btn-accent btn-sm" href="{{ route('supervisor.assign', ['id' => $reservation->researcher_id, 'eq_id' => $reservation->eq_id]) }}">Assign Reservation</a></td>
